...
export const Article: React.FC = () => {
  ...
  const handleImageError = (e: React.SyntheticEvent<HTMLImageElement, Event>) => {
    ...
    e.currentTarget.src = "https://images.unsplash.com/photo-1498837167922-ddd27525d352?auto=format&fit=crop&q=80&w=1200";
    e.currentTarget.alt = "Fallback image";
  };

  // Función reutilizable para MailerLite
                 ...
                 <div className="not-prose mt-16 p-1 rounded-3xl bg-gradient-to-br from-brand-100 to-accent-100 shadow-xl">
                    <div className="bg-white rounded-[20px] p-8 md:p-12 text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            {/* BOTÓN 1: FINAL DEL ARTÍCULO */}
                            <button 
                                onClick={handleMLClick}
                                className="ml-onclick-form bg-brand-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-brand-700 hover:shadow-lg hover:-translate-y-1 transition-all"
                            >
              ...
              <div className="sticky top-28 space-y-10">
                ...
                <div className="bg-gray-900 rounded-2xl p-6 text-center text-white relative overflow-hidden">
                   <div className="relative z-10">
                      ...
                      {/* BOTÓN 2: BARRA LATERAL */}
                      <button 
                        onClick={handleMLClick}
                        className="ml-onclick-form w-full py-3 bg-brand-600 rounded-xl font-bold hover:bg-brand-500 transition-colors shadow-lg shadow-brand-900/50"
                      >
